                ...
                return (
                    <div key={idx} data-date={date.toISOString()} className="bg-neutral-900 min-h-[500px] flex flex-col">
                        <div className="p-5 border-b border-neutral-800 bg-neutral-950 text-center">
                            ...
                            <span className={`text-xl font-black inline-flex items-center justify-center w-10 h-10 rounded-xl ${isToday ? 'bg-[#dc0014] text-white shadow-md' : 'text-gray-500'}`}>{date.getDate()}</span>
                        </div>
