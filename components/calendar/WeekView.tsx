                            ...
                            {dayEvents.map(event => {
                                ...
                                return (
                                    <motion.div
                                        ...
                                        className="z-10 bg-white p-4 rounded-[1.5rem] border border-gray-100 transition-all hover:shadow-lg shadow-sm"
                                    ...
                                    >
                                        <div className="flex flex-wrap gap-1.5 mb-2.5">
                                            {event.tags
                                                ...
                                                .map((tag, tIdx) => (
                                                    <span
                                                        key={tIdx}
                                                        className="text-[8px] uppercase font-black px-2 py-0.5 rounded-full bg-white text-black/70 border border-gray-200"
                                        ...
                                        <div className="text-[15px] font-black leading-tight cursor-pointer hover:opacity-80 transition-colors" style={{ color: getEventStyle(event).color, filter: 'brightness(0.7)' }} onClick={(e) => { e.stopPropagation(); onOpenEvent(event); }}>{event.title}</div>
                                    </motion.div>
                                );
                            })}
                        </div>
